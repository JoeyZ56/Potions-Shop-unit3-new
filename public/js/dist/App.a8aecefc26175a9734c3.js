...
function NewOrderPage(_ref) {
  ...
  }, /*#__PURE__*/React.createElement("aside", null, /*#__PURE__*/React.createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_10__.Link, {
    to: "/about",
    className: "toAboutPage"
  }, "About us"), /*#__PURE__*/React.createElement(_components_Logo_Logo__WEBPACK_IMPORTED_MODULE_2__["default"], null), /*#__PURE__*/React.createElement(_components_CategoryList_CategoryList__WEBPACK_IMPORTED_MODULE_4__["default"], {
...
}`, "",{"version":3,"sources":["webpack://./src/components/CategoryList/CategoryList.module.scss"],"names":[],"mappings":"AAAA;EACI,mBAAA;EACA,gBAAA;EACA,UAAA;EACA,cAAA;AACJ;;AAEI;EACA,gBAAA;EACA,kBAAA;EACA,sBAAA;EACA,sBAAA;AACJ;;AAEI;EACA,eAAA;EACA,yBAAA;EACA,kCAAA;EACA,mBAAA;AACJ;;AAEI;EACA,uBAAA;EACA,8BAAA;EACA,kCAAA;AACJ","sourcesContent":[".CategoryList {\n    color: var(--white);\n    list-style: none;\n    padding: 0;\n    font-size: 2vw;\n    }\n    \n    .CategoryList li {\n    padding: .6vmin;\n    text-align: center;\n    border-radius: .5vmin;\n    margin-bottom: .5vmin;\n    }\n    \n    .CategoryList li:hover:not(.active) {\n    cursor: pointer;\n    background-color: #732888;\n    border: 0.1vmin solid var(--tan-2);;\n    color: var(--white);\n    }\n    \n    .CategoryList li.active {\n    color: var(--text-dark);\n    background-color: var(--tan-1);\n    border: .1vmin solid var(--tan-3);\n    }"],"sourceRoot":""}]);
// Exports
...
___CSS_LOADER_EXPORT___.push([module.id, `.EDeinQzfS2N2rVW_Z1GP {
  ...
  align-items: center;
  border-radius: 50%;
  background-image: url("https://tse4.mm.bing.net/th?id=OIP.Xk8GPqrFQ5O__8mBBhFq5gHaH4&pid=Api&P=0&h=220");
  background-size: 100% 100%;
  color: rgb(8, 221, 8);
  font-size: 4vmin;
  border: 0.6vmin solid var(--tan-2);
  margin-top: 3vmin;
  filter: drop-shadow(0px 20px 25px black);
}

.ZXOnLWKoFcklM34sme6w {
  margin-top: 50px;
}`, "",{"version":3,"sources":["webpack://./src/components/Logo/Logo.module.scss"],"names":[],"mappings":"AAAA;EACI,cAAA;EACA,aAAA;EACA,aAAA;EACA,sBAAA;EACA,uBAAA;EACA,mBAAA;EACA,kBAAA;EACA,wGAAA;EACA,0BAAA;EACA,qBAAA;EACA,gBAAA;EACA,kCAAA;EACA,iBAAA;EACA,wCAAA;AACJ;;AACI;EACI,gBAAA;AAER","sourcesContent":[".Logo {\n    height: 22vmin;\n    width: 22vmin;\n    display: flex;\n    flex-direction: column;\n    justify-content: center;\n    align-items: center;\n    border-radius: 50%;\n    background-image: url('https://tse4.mm.bing.net/th?id=OIP.Xk8GPqrFQ5O__8mBBhFq5gHaH4&pid=Api&P=0&h=220');\n    background-size: 100% 100%;\n    color: rgb(8, 221, 8);\n    font-size: 4vmin;\n    border: .6vmin solid var(--tan-2);\n    margin-top: 3vmin;\n    filter: drop-shadow(0px 20px 25px black);\n    }\n    .title {\n        margin-top: 50px;\n    }\n"],"sourceRoot":""}]);
// Exports
___CSS_LOADER_EXPORT___.locals = {
...
.RZqTJBeYN7RXwcHgPFys .R17zS3U1lXNLx1RFpbEO {
  color: var(--white);
}`, "",{"version":3,"sources":["webpack://./src/pages/NewOrderPage/NewOrderPage.module.scss"],"names":[],"mappings":"AAAA;EACI,YAAA;EACA,aAAA;EACA,sCAAA;EACA,uBAAA;EACA,oBAAA;AACJ;;AAEE;EACE,aAAA;EACA,sBAAA;EACA,8BAAA;EACA,mBAAA;EACA,mBAAA;AACJ;;AAEA;EACE,mBAAA;AACF","sourcesContent":[".NewOrderPage {\n    height: 100%;\n    display: grid;\n    grid-template-columns: 1.6fr 3.5fr 3fr;\n    grid-template-rows: 1fr;\n    border-radius: 2vmin;\n  }\n  \n  .NewOrderPage aside {\n    display: flex;\n    flex-direction: column;\n    justify-content: space-between;\n    align-items: center;\n    margin: 3vmin 2vmin;\n  }\n \n.NewOrderPage .linkAbout {\n  color: var(--white);\n}"],"sourceRoot":""}]);
// Exports
___CSS_LOADER_EXPORT___.locals = {
